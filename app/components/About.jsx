...
function About() {
  return (
    <>
      <div className="w-[80%] lg:w-full lg:px-32 my-10 mx-auto py-16 grid lg:bg-gray-100 lg:grid-cols-2 gap-8 items-center">
        {/* Text Section */}
        <div>
          <h3 className="text-lg text-[#D4A10F]">AL HABIB TRAVEL LTD</h3>
          ...
          <h2 className="text-lg py-3 font-bold text-gray-600">
            We are a choice of many because of our:
          </h2>
          <ul className="list-disc text-slate-600 leading-8 pl-8">
            <li>Affordable services with exceptional value</li>
            <li>Flavorful meals that satisfy.</li>
            <li>Dedicated 24/7 support.</li>
          </ul>

          <p className="text-lg py-3 font-bold text-gray-600">
      ...
      <div className="w-[80%] mx-auto pb-10">
        <h2 className="text-lg text-[#D4A10F]">TESTIMONIALS</h2>
        <h1 className="text-2xl font-bold">What Our <span className="text-[#D4A10F]">Clients</span> Say!</h1>
      </div>
    </>
  );
}
